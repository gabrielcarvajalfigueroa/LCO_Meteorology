"""
Django settings for meteorologyProject project.
...
SECRET_KEY = 'django-insecure-&bmp06ozd)lghk$y89x57qjqx7ct+@vlr*@^cd3@dorzaom&%r'
...
ROOT_URLCONF = 'meteorologyProject.urls'
...
WSGI_APPLICATION = 'meteorologyProject.wsgi.application'
